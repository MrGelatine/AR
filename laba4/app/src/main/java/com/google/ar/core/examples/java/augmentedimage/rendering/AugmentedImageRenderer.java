...
public class AugmentedImageRenderer {
  ...
  public void draw(
    ...
    float[] trueColor = {colorCorrectionRgba[0] * 0.4f + tintColor[0] * 0.6f, colorCorrectionRgba[1] * 0.4f + tintColor[1] * 0.6f, colorCorrectionRgba[2] * 0.4f + tintColor[2] * 0.6f, 1.0f};
    ...
    andyRenderer.draw(viewMatrix, projectionMatrix, trueColor, tintColor);
